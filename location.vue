                ...
                <div class="main_container margin_30">
                    <div class="details_row">
                        ...
                        <div class="details_col_9">
                            <iframe title="Map" width="100%" height="300[x" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  :src="'http://maps.google.nl/maps?q=' + getPropertyAddress + '&amp;hl=en&amp;ie=UTF8&amp;t=v&amp;hnear=' + getPropertyAddress + '&amp;z=16&amp;output=embed'"></iframe>
	...
	define(["Vue", "vuex", "json!site.json"], function(Vue, Vuex, site) {
		return Vue.component("location-component", {
            ...
            computed: {
                ...
                getPropertyAddress() {
                    console.log(this.property.name + ' ' + this.property.address1 + ' ' + this.property.city + ' ' + this.property.country + ' ' +this.property.province_state + ' ' + this.property.province_state)
